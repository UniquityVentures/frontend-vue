...
export const getDefaultEmptyValue = (fieldType) => {
  ...
  if ([FIELD_TYPES.MULTI_SELECT, FIELD_TYPES.ATTACHMENT_LIST].includes(fieldType) || 
      [FIELD_TYPES.BATCHES, FIELD_TYPES.COURSES, FIELD_TYPES.TEACHERS, FIELD_TYPES.STUDENTS, FIELD_TYPES.PAYEES].includes(fieldType)) {
    return [];
  }
